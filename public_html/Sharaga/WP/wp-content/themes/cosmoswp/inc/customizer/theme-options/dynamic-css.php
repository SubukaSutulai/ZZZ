...
if ($site_border_style && 'none' !== $site_border_style){
...
if ($site_hover_border_style && 'none' !== $site_hover_border_style) {
...
if ( ! empty( $cosmoswp_sidebar_widget_css ) ) {
	$widget_content_dynamic_css       = '.cwp-sidebar .widget:not(.widget_gutentor_wp_block_widget){
		' . $cosmoswp_sidebar_widget_css . '
	}';
...
if ( ! empty( $cosmoswp_sidebar_widget_tablet_css ) ) {
	$cosmoswp_sidebar_widget_tablet_dynamic_css = '.cwp-sidebar .widget:not(.widget_gutentor_wp_block_widget){
		' . $cosmoswp_sidebar_widget_tablet_css . '
	}';
...
if ( ! empty( $cosmoswp_sidebar_widget_desktop_css ) ) {
	$cosmoswp_sidebar_widget_desktop_dynamic_css = '.cwp-sidebar .widget:not(.widget_gutentor_wp_block_widget){
		' . $cosmoswp_sidebar_widget_desktop_css . '
	}';
...
if ( ! empty( $cosmoswp_widget_link_css ) ) {
	$widget_link_dynamic_css          = '.cwp-sidebar .widget:not(.widget_gutentor_wp_block_widget) a, .cwp-sidebar .widget:not(.widget_gutentor_wp_block_widget) li a{
...
if ( $breadcrumb_text_color ) {
	$theme_option_dynamic_css['all'] .= '.cwp-banner .breadcrumbs,.cwp-body-main-wrap .breadcrumbs,
...
if ($scroll_top_icon_hover_border_style && 'none' !== $scroll_top_icon_hover_border_style) {
